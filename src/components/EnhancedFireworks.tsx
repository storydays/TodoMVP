...
const EnhancedFireworks: React.FC<EnhancedFireworksProps> = ({ intensity, message, onComplete }) => {
  ...
  useEffect(() => {
    ...
    for (let i = 0; i < burstCount; i++) {
      setTimeout(() => {
        ...
        allParticles = [...allParticles, ...burst];
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-50 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className={`text-center animate-celebration-bounce drop-shadow-2xl ${
      ...
      {/* Ground sparkles */}
      <div className="absolute bottom-0 left-0 w-full h-20 bg-gradient-to-t from-holi-golden/30 via-holi-emerald/20 to-transparent animate-pulse" />
    </div>
  );
};
